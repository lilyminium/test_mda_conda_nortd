...
We welcome all contributions to Test Project with Anaconda and no ReadTheDocs!

Contributions can take many forms, such as:

* sharing bug reports or feature requests through the [Issue Tracker](https://github.com/lilyminium/test_mda_conda_nortd/issues)
...
The second two options both involve making a [pull request](https://github.com/lilyminium/test_mda_conda_nortd/pulls) .
